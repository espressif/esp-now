...
#ifdef CONFIG_APP_ESPNOW_INITIATOR
    iot_button_register_cb(button_handle, BUTTON_SINGLE_CLICK, NULL, app_wifi_prov_over_espnow_start_press_cb, NULL);
#endif
    iot_button_register_cb(button_handle, BUTTON_DOUBLE_CLICK, NULL, app_wifi_prov_start_press_cb, NULL);
    iot_button_register_cb(button_handle, BUTTON_LONG_PRESS_START, NULL, app_wifi_prov_reset_press_cb, NULL);
}
#endif
